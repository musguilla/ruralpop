...
export function NativeAdCard() {
    ...
    return (
        <View className="bg-surface rounded-2xl overflow-hidden border border-gray-200 mb-4 shadow-sm items-center justify-center p-2 bg-gray-50 self-center w-full">
            <BannerAd
                unitId={adUnitID}
