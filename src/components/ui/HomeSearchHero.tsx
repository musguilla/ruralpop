...
const VISUAL_CATEGORIES = [
    ...
    { id: "recambios-maquinaria", type: "category", label: "Recambios", icon: <Image src="/icon-repuestos.jpg" alt="Recambios" width={48} height={48} className="object-contain rounded-lg" /> },
    { id: "equipamiento-y-material", type: "category", label: "Equipamiento", icon: <Image src="/icon-equipamiento.jpg" alt="Equipamiento" width={48} height={48} className="object-contain rounded-lg" /> },
    ...
    { id: "coches", type: "category", label: "Coches", icon: <Image src="/icon-coches.jpg" alt="Coches" width={48} height={48} className="object-contain rounded-lg" /> },
    { id: "atv", type: "category", label: "ATV", icon: <Image src="/icon-atv.jpg" alt="ATV" width={48} height={48} className="object-contain rounded-lg" /> },
    { id: "motos", type: "category", label: "Motos", icon: <Image src="/icon-motos.jpg" alt="Motos" width={48} height={48} className="object-contain rounded-lg" /> },
    ...
    { id: "genetica-y-reproduccion", type: "category", label: "Genética", icon: <Image src="/icon-genetica.jpg" alt="Genética" width={48} height={48} className="object-contain rounded-lg" /> },
