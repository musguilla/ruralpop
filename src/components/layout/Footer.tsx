            ...
            <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-4 mt-4 sm:mt-0">
                    ...
                    <div className="relative group">
                        <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[var(--ag-sys-color-primary)] text-white text-[9px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider z-10 whitespace-nowrap shadow-sm group-hover:-translate-y-0.5 transition-transform duration-300">Próximamente</span>
                        <div className="flex items-center bg-black text-white px-4 py-2 rounded-xl cursor-default opacity-80 border border-gray-800 pointer-events-none">
