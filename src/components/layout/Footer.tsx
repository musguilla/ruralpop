        ...
        <footer className="w-full border-t border-[var(--ag-sys-color-border)] bg-[var(--ag-sys-color-surface)] py-8 mt-auto">
            <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-4 mt-4 sm:mt-0 shrink-0">
                    ...
                    <a href="https://apps.apple.com/es/app/ruralpop/id6759678666" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1.5 hover:opacity-80 transition-all cursor-pointer shrink-0" title="Descargar en el App Store">
                        <div className="flex items-center bg-black text-white px-4 py-2 rounded-xl border border-gray-800">
                            <svg viewBox="0 0 384 512" width="24" height="24" fill="currentColor" className="mr-3 shrink-0">
