                ...
                <button
                    ...
                    className={clsx(
                        ...
                        loading 
                            ...
                            : "bg-[var(--ag-sys-color-surface)] text-[var(--ag-sys-color-text)] hover:bg-gray-100 border border-[var(--ag-sys-color-border)] active:scale-[0.98] shadow-sm hover:shadow-md"
                    )}
                >
                    {loading ? (
                        <>
