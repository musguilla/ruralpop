...
export default function UpdatePasswordPage() {
    ...
    useEffect(() => {
        // Al montar el componente en el cliente, supabase-js procesará automáticamente el hash
        // de la URL (#access_token=...) y establecerá la sesión.
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (updateError) {
            ...
            setTimeout(() => {
                router.push("/login?message=Tu contraseña se ha cambiado correctamente. Ya puedes iniciar sesión.");
            }, 3000);
        }
    };
