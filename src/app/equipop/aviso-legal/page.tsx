...
export const metadata: Metadata = {
    title: "Aviso Legal | Equipop",
    description: "Aviso legal, condiciones de navegación y responsabilidades del sitio web de Equipop.",
};
            ...
            <div className="max-w-4xl mx-auto bg-[var(--ag-sys-color-surface)] border border-[var(--ag-sys-color-border)] rounded-[2rem] p-8 sm:p-12 shadow-sm">
                <header className="mb-8 border-b border-[var(--ag-sys-color-border)] pb-8 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[var(--ag-sys-color-text-muted)] mt-1 font-medium">Sitio Web y Aplicación Equipop</p>
                    </div>
                </header>

                <div className="prose prose-sm sm:prose-base max-w-none text-[var(--ag-sys-color-text)] leading-relaxed space-y-6">
                    <h2 className="text-2xl font-bold mt-10 mb-4 text-[var(--ag-sys-color-text)]">¿Quién es el titular del sitio web y la aplicación Equipop?</h2>
                    ...
                    <p>
                        Este Aviso Legal establece las condiciones que regulan el acceso, navegación y uso del sitio web de Equipop y, en su caso, de su aplicación móvil, incluyendo la mera navegación por cualquiera de ellos.
                    </p>
                    ...
                    <p>
                        En Equipop procuramos mejorar continuamente la accesibilidad del sitio web y de la aplicación, con el objetivo de facilitar el acceso a sus contenidos y servicios al mayor número de usuarios posible.
                    </p>
                    <p>
                        Equipop podrá interrumpir temporalmente el acceso al sitio web o a la aplicación por motivos de seguridad, mantenimiento técnico, actualización, incidencias de suministro o cualquier otra causa técnica. Cuando ello sea posible, se informará a los usuarios de dichas interrupciones.
                    </p>
                    ...
                    <p>
                        El acceso, navegación o uso del sitio web y/o de la aplicación de Equipop atribuye a quien lo realiza la condición de usuario e implica la aceptación del presente Aviso Legal desde el momento en que se produce dicho acceso.
                    </p>
                    <p>
                    ...
                    <p>
                        Equipop no garantiza la disponibilidad permanente, la continuidad absoluta ni la ausencia de errores en el funcionamiento del sitio web o de la aplicación. En la medida permitida por la legislación aplicable, Equipop no será responsable de los daños o perjuicios que pudieran derivarse de interrupciones del servicio, caídas, errores técnicos, virus, interferencias de terceros, incidencias en redes de telecomunicaciones, fuerza mayor o cualesquiera otras circunstancias ajenas a su control razonable.
                    </p>
                    ...
                    <p>
                        Equipop es titular o, en su caso, cuenta con licencia o autorización suficiente sobre los derechos de propiedad intelectual e industrial del sitio web, la aplicación y todos sus contenidos, incluyendo, a título enunciativo y no limitativo, textos, imágenes, diseños, logotipos, marcas, nombres comerciales, vídeos, audios, bases de datos, estructura, software, código fuente, funcionalidades y demás elementos que los integran.
                    </p>
                    <p>
                        El usuario se compromete a respetar todos los derechos de propiedad intelectual e industrial titularidad de Equipop o de terceros.
                    </p>
                    <p>
                    ...
                    <p>
                        Las marcas, nombres comerciales o signos distintivos que aparezcan en el sitio web o en la aplicación son titularidad de Equipop o de terceros, sin que pueda entenderse que el acceso o uso atribuya al usuario derecho alguno sobre los mismos.
                    </p>
                    <p className="font-bold">
                        Copyright Equipop &copy; 2026 – Todos los derechos reservados
                    </p>
                    ...
                    <p>
                        Equipop, como titular del sitio web y de la aplicación, cumple con el Reglamento (UE) 2016/679, la Ley Orgánica 3/2018, la Ley 34/2002, de 11 de julio, de servicios de la sociedad de la información y de comercio electrónico, y demás normativa aplicable en materia de protección de datos y servicios digitales.
                    </p>
                    <p>
                        Equipop vela por garantizar un tratamiento adecuado de los datos personales de los usuarios, así como un uso correcto de cookies y tecnologías similares.
                    </p>
                    <p>
                        Para más información, puedes consultar la Política de Privacidad y la Política de Cookies de Equipop.
                    </p>
                    ...
                    <p>
                        En caso de que el sitio web o la aplicación incluyan enlaces o hipervínculos a otros sitios de Internet gestionados por terceros, Equipop no ejercerá control alguno sobre dichos sitios ni sobre sus contenidos.
                    </p>
                    <p>
                        En ningún caso Equipop asumirá responsabilidad alguna por los contenidos, políticas, prácticas o disponibilidad técnica de sitios web de terceros enlazados desde su plataforma, ni garantizará la fiabilidad, exactitud, legalidad, validez o actualidad de los materiales o informaciones contenidos en ellos.
                    </p>
                    <p>
                        La inclusión de estos enlaces no implicará, en ningún caso, asociación, fusión, colaboración o participación alguna entre Equipop y las entidades enlazadas, salvo que se indique expresamente lo contrario.
                    </p>
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li>Realizar actos de ingeniería inversa, extracción masiva de datos, scraping, copia automatizada o cualquier conducta que perjudique a Equipop o a otros usuarios.</li>
                    </ul>
                    <p>
                        Equipop podrá adoptar cuantas medidas técnicas, legales u organizativas resulten necesarias ante incumplimientos del presente Aviso Legal o del resto de textos legales de la plataforma, incluyendo la suspensión o cancelación del acceso, sin perjuicio de las acciones civiles, penales o administrativas que pudieran corresponder.
                    </p>
                    <p>
                        El usuario responderá frente a Equipop o frente a terceros de cualesquiera daños y perjuicios que pudieran derivarse del incumplimiento de estas obligaciones.
                    </p>
                    ...
                    <p>
                        En la fecha de la última actualización del presente Aviso Legal, Equipop no publica en este apartado ninguna cifra específica de promedio mensual de destinatarios activos en la Unión Europea.
                    </p>
                    <p>
                        Equipop podrá actualizar esta sección cuando resulte necesario o legalmente exigible conforme a la evolución de la plataforma y a la normativa aplicable.
                    </p>
                    ...
                    <p>
                        Para cualquier consulta relacionada con el sitio web, la aplicación, este Aviso Legal o cualquier cuestión jurídica relacionada con Equipop, puedes ponerte en contacto a través de los siguientes correos electrónicos:
                    </p>
                    <ul className="list-none space-y-1">
                        <li>
                        ...
                        <li><strong>Protección de datos:</strong> privacidad@equipop.com</li>
                    </ul>
