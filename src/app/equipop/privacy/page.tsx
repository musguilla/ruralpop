            ...
            <div className="max-w-4xl mx-auto bg-[var(--ag-sys-color-surface)] border border-[var(--ag-sys-color-border)] rounded-[2rem] p-8 sm:p-12 shadow-sm">
                ...
                <div className="prose prose-sm sm:prose-base max-w-none text-[var(--ag-sys-color-text)] leading-relaxed space-y-6">
                    <p>
                        ...
                        servicios de Equipop, así como a través de las áreas públicas y privadas, según
                        corresponda, del sitio web y de la aplicación móvil de Equipop.
                    </p>
                    <p>
                    ...
                    <p>Equipop podrá tratar, según el uso que hagas de la plataforma, las siguientes categorías de datos personales:</p>
                    <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li>Información relativa a los anuncios publicados, productos, animales, maquinaria, servicios o contenidos que publiques en Equipop</li>
                        <li>Comunicaciones mantenidas con otros usuarios o con Equipop a través de formularios, mensajería o soporte</li>
                    ...
                    <ul className="list-none space-y-4">
                        <li>
                            <strong>Alta y gestión de la cuenta de usuario:</strong> Tratamos tus datos para darte de alta como usuario en Equipop, permitirte acceder a tu cuenta, gestionar tu perfil y prestarte los servicios disponibles en la plataforma.
                        ...
                        <li>
                            <strong>Publicación y gestión de anuncios:</strong> Tratamos tus datos para permitir la publicación, edición, gestión y visibilidad de anuncios en Equipop.
                            <br /><em>Base legitimadora: ejecución de un contrato.</em>
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Mensajería interna entre usuarios:</strong> Cuando utilices el formulario de contacto o el sistema de chat o mensajería dentro de Equipop, tus mensajes podrán ser tratados para facilitar la comunicación entre usuarios y el correcto funcionamiento del servicio.
                    ...
                    <ul className="list-none space-y-4">
                        <li>
                            <strong>Análisis de uso y mejora de la plataforma:</strong> Tratamos datos de navegación, uso, interacción y comportamiento dentro de Equipop para analizar el funcionamiento de la plataforma, mejorar la experiencia de usuario, detectar errores y optimizar servicios y contenidos.
                            <br /><em>Base legitimadora: interés legítimo y, cuando sea exigible, consentimiento conforme a la política de cookies.</em>
                        </li>
                        <li>
                            <strong>Elaboración de estadísticas agregadas:</strong> Podremos elaborar informes estadísticos internos, agregados o anonimizados sobre el uso de Equipop, categorías más consultadas, volumen de publicaciones, interacción con contenidos y otras métricas de actividad.
                    ...
                    <ul className="list-none space-y-4">
                        <li>
                            <strong>Envío de comunicaciones comerciales propias:</strong> Podremos enviarte información sobre novedades, mejoras, productos, servicios, promociones o funcionalidades de Equipop por medios electrónicos cuando exista una relación previa y la normativa lo permita, o cuando nos hayas dado tu consentimiento.
                        ...
                        <li>
                            <strong>Encuestas de satisfacción y estudios de calidad:</strong> Podremos enviarte encuestas para conocer tu opinión sobre Equipop, sus funcionalidades y la experiencia de usuario, con el fin de mejorar nuestros servicios.
                            <br /><em>Base legitimadora: interés legítimo.</em>
                        </li>
                        <li>
                            <strong>Participación en promociones, sorteos o concursos:</strong> Si participas en promociones, sorteos o concursos organizados por Equipop, trataremos tus datos para gestionar tu participación y, en su caso, la entrega de premios, conforme a las bases legales aplicables.
                    ...
                    <p>
                        Tratamos tus datos para prevenir abusos, accesos no autorizados, suplantaciones de identidad, actividades fraudulentas, ataques informáticos, spam y cualquier uso ilícito o contrario a las condiciones de uso de Equipop.
                        <br /><em>Base legitimadora: interés legítimo.</em>
                    </p>
                    <p>
                        En caso de detectar conductas sospechosas o contrarias a la normativa o a las condiciones de uso, Equipop podrá limitar, suspender o cancelar cuentas, anuncios o contenidos.
                    </p>
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                        <li>Mientras mantengas tu cuenta activa en Equipop o sigas utilizando nuestros servicios.</li>
                    ...
                    <p>
                        Equipop puede incluir enlaces a sitios web, servicios, aplicaciones o plataformas de terceros. En estos casos, el uso de dichos servicios se regirá por las políticas de privacidad y condiciones legales de esos terceros, siendo estos los únicos responsables de sus propios tratamientos de datos.
                    </p>
                    <p>
                        Equipop no se responsabiliza de los tratamientos de datos realizados por terceros ajenos a su organización.
                    </p>
                    ...
                    <ul className="list-none space-y-4">
                        <li>
                            <strong>Otros usuarios de Equipop:</strong> Cuando publiques anuncios o contactes con otros usuarios, determinados datos podrán ser visibles o ser comunicados a dichos usuarios en la medida necesaria para facilitar la compraventa, el contacto o la prestación del servicio.
                        </li>
                        <li>
                            <strong>Proveedores de servicios:</strong> Equipop podrá apoyarse en terceros proveedores que actúen como encargados del tratamiento para prestar servicios tales como alojamiento web, almacenamiento, email, mensajería, notificaciones, analítica, soporte técnico, pagos, seguridad, prevención del fraude o atención al cliente. Estos proveedores tratarán los datos únicamente siguiendo instrucciones de Equipop y bajo contrato.
                        </li>
                        <li>
                            <strong>Proveedores de pago o facturación:</strong> Si Equipop ofrece servicios de pago, suscripción, promoción de anuncios o funcionalidades premium, los datos necesarios podrán ser comunicados a proveedores de pago, pasarelas de cobro o entidades financieras para gestionar la operación.
                        </li>
                        <li>
                            <strong>Empresas de transporte o logística:</strong> En caso de que Equipop incorpore servicios de envío o logística, los datos estrictamente necesarios podrán comunicarse a empresas de transporte para gestionar entregas o devoluciones.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Transferencias internacionales:</strong> Algunos proveedores tecnológicos pueden estar ubicados fuera del Espacio Económico Europeo. En esos casos, Equipop adoptará las garantías adecuadas conforme al RGPD, como cláusulas contractuales tipo aprobadas por la Comisión Europea o mecanismos equivalentes.
                        </li>
                    </ul>
                    ...
                    <p className="mt-4">
                        Para ejercer tus derechos, puedes escribir a: <strong>privacidad@equipop.com</strong> indicando claramente tu solicitud, nombre y apellidos y el correo electrónico vinculado a tu cuenta.
                    </p>
                    <p>
