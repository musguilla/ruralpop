            ...
            <div className="max-w-4xl mx-auto bg-[var(--ag-sys-color-surface)] border border-[var(--ag-sys-color-border)] rounded-[2rem] p-8 sm:p-12 shadow-sm">
                <header className="mb-8 border-b border-[var(--ag-sys-color-border)] pb-8 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[var(--ag-sys-color-text-muted)] mt-1 font-medium">Uso de cookies en Equipop</p>
                    </div>
                </header>

                <div className="prose prose-sm sm:prose-base max-w-none text-[var(--ag-sys-color-text)] leading-relaxed space-y-6">
                    <p>
                        Esta Política de Cookies explica el uso de cookies y tecnologías similares en el sitio web y, en su caso, en la aplicación móvil de Equipop, titularidad de:
                    </p>
                    ...
                    <p>
                        Asimismo, Equipop puede utilizar tecnologías similares a las cookies, como píxeles, etiquetas, identificadores o web beacons, propias o de terceros, que permiten recopilar información sobre la navegación, medir la eficacia de campañas, recordar preferencias o personalizar contenidos y publicidad.
                    </p>
                    ...
                    <ul className="list-none space-y-4">
                        <li>
                            <strong>Cookies propias:</strong> Son aquellas enviadas a tu dispositivo desde un equipo o dominio gestionado por Equipop y desde el que se presta el servicio solicitado.
                        </li>
                        <li>
                            <strong>Cookies de terceros:</strong> Son aquellas enviadas a tu dispositivo desde un equipo o dominio que no es gestionado por Equipop, sino por otra entidad colaboradora o proveedora de servicios.
                        </li>
                    </ul>
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-4 text-[var(--ag-sys-color-text)]">3. ¿Qué cookies utiliza Equipop?</h2>
                    <p>
                        Equipop utiliza cookies propias y de terceros con finalidades técnicas y, en su caso, analíticas. Algunas cookies son estrictamente necesarias para el funcionamiento de la plataforma y no requieren consentimiento. Otras, como las analíticas, solo se instalarán si el usuario las acepta expresamente a través del panel de configuración o banner de cookies.
                    </p>

                    <h3 className="text-xl font-semibold mt-6 mb-3">3.1. Cookies técnicas y de sesión (estrictamente necesarias)</h3>
                    <p>
                        Estas cookies son necesarias para que Equipop funcione correctamente, para mantener tu sesión iniciada y para permitir funcionalidades esenciales como acceder a tu perfil, publicar anuncios o utilizar el chat interno.
                    </p>
                    <ul className="list-none space-y-4">
                        <li>
                            <strong>a) Cookie de autenticación de sesión</strong><br />
                            Nombre: <code>sb-[ref-del-proyecto]-auth-token</code><br />
                            Titularidad: Equipop (a través de Supabase)<br />
                    ...
                    <p>
                        Estas cookies son imprescindibles para la prestación del servicio solicitado por el usuario y, por tanto, no pueden desactivarse desde el panel de configuración salvo mediante la propia configuración del navegador, lo que podría impedir el correcto funcionamiento de Equipop.
                    </p>

                    <h3 className="text-xl font-semibold mt-6 mb-3">3.2. Cookies de análisis y estadísticas</h3>
                    <p>
                        Estas cookies permiten medir el uso del sitio web, diferenciar usuarios, conocer el origen del tráfico y analizar cómo interactúan los visitantes con Equipop, con la finalidad de mejorar la plataforma y sus servicios.
                    </p>
                    <p>
                    ...
                    <p>A continuación, se resumen las cookies principales utilizadas actualmente por Equipop:</p>
                        ...
                        <table className="min-w-full text-sm text-left align-middle">
                            ...
                            <tbody className="divide-y divide-[var(--ag-sys-color-border)]">
                                <tr>
                                    ...
                                    <td className="px-4 py-3">Equipop (Supabase)</td>
                    ...
                    <p className="text-sm italic">
                        Equipop podrá actualizar esta tabla cuando se incorporen nuevas cookies, herramientas de medición o funcionalidades adicionales en la web o en la aplicación.
                    </p>
                    ...
                    <p>
                        Puedes configurar el uso de cookies a través del panel o banner de configuración habilitado por Equipop al acceder al sitio web. Desde dicho panel podrás aceptar, rechazar o configurar el uso de las cookies no necesarias.
                    </p>
                    ...
                    <p>
                        Equipop puede utilizar servicios de terceros que, por cuenta de Equipop, recopilen información con fines estadísticos, técnicos, analíticos o de medición del uso del sitio web o de la aplicación.
                    </p>
                    <p>
                        En la actualidad, Equipop utiliza servicios de Google Analytics, prestados por Google Ireland Limited, para obtener estadísticas agregadas sobre navegación, tráfico y comportamiento de los usuarios, siempre sujeto al consentimiento previo del usuario cuando sea exigible.
                    </p>
                    <p>
                    ...
                    <p>
                        La base jurídica para el uso de cookies técnicas o estrictamente necesarias es el interés legítimo de Equipop en garantizar el funcionamiento correcto, seguro y operativo del sitio web y de la aplicación, así como la correcta prestación del servicio solicitado por el usuario.
                    </p>
                    <p>
                    ...
                    <p>
                        Para consultar el resto de información sobre cómo tratamos tus datos personales, los plazos de conservación, destinatarios o el ejercicio de derechos, puedes acceder a la <a href="/privacy" className="text-[var(--ag-sys-color-primary)] hover:underline">Política de Privacidad de Equipop</a>.
                    </p>
                    ...
                    <p>
                        Equipop podrá modificar la presente Política de Cookies en cualquier momento para adaptarla a cambios legislativos, técnicos o funcionales, así como para reflejar nuevas cookies o nuevos tratamientos de datos.
                    </p>
                    <p>
                    ...
                    <p>
                        <strong>privacidad@equipop.com</strong>
                    </p>
