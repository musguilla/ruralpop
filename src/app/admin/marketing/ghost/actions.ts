        ...
        const emailHtml = `
            ...
            <body>
                <div class="container">
                    ...
                    <p class="footer">
                        © ${new Date().getFullYear()} Ruralpop - El mercado líder del mundo rural.
                    </p>
                </div>
            </body>
            </html>
