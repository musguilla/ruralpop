...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const urlPath = `/tractores/cultivo/${resolvedParams.slug}/${resolvedParams.province}`;
...
export default async function Page({ params }: Props) {
    const resolvedParams = await params;
    return <TractorCombinationPage urlPath={`/tractores/cultivo/${resolvedParams.slug}/${resolvedParams.province}`} />;
}
