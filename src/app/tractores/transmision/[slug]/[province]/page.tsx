...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const urlPath = `/tractores/transmision/${params.slug}/${params.province}`;
...
export default function Page({ params }: Props) {
    return <TractorCombinationPage urlPath={`/tractores/transmision/${params.slug}/${params.province}`} />;
}
