...
export async function generateMetadata(props: Props): Promise<Metadata> {
    ...
    const urlPath = `/tractores/uso/${resolvedParams.slug}/${resolvedParams.province}`;
...
export default async function Page({ params }: Props) {
    const resolvedParams = await params;
    return <TractorCombinationPage urlPath={`/tractores/uso/${resolvedParams.slug}/${resolvedParams.province}`} />;
}
