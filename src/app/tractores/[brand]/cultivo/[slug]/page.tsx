...
export async function generateMetadata(props: Props): Promise<Metadata> {
    ...
    const urlPath = `/tractores/${resolvedParams.brand}/cultivo/${resolvedParams.slug}`;
...
export default async function Page({ params }: Props) {
    const resolvedParams = await params;
    return <TractorCombinationPage urlPath={`/tractores/${resolvedParams.brand}/cultivo/${resolvedParams.slug}`} />;
}
