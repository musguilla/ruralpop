...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const urlPath = `/tractores/${resolvedParams.brand}/potencia/${resolvedParams.slug}`;
...
export default async function Page({ params }: Props) {
    const resolvedParams = await params;
    return <TractorCombinationPage urlPath={`/tractores/${resolvedParams.brand}/potencia/${resolvedParams.slug}`} />;
}
