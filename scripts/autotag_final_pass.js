...
async function main() {
    ...
    console.log("=== Final Deterministic Pass for ALL Ruralpop Listings ===");
    ...
    while (true) {
        ...
        under3Count += needingUpdate.length;
    ...
    console.log(`\n🎉 FINAL RESULTS: Scanned ${totalScanned} listings | Updated ${totalUpdated} listings.`);
}
