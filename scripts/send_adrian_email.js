...
async function main() {
    ...
    const recipient = 'ing.adriangutierrez@gmail.com';
...
<body>
    <div class="container">
        ...
        <h1 class="title">Registro en Ruralpop solucionado</h1>
        ...
        <p class="text">
            Te escribimos para avisarte de que la incidencia puntual que impedía el registro ya ha sido solucionada.
        </p>

        <p class="text">
            Ya puedes crear tu cuenta de forma normal desde la <strong>App de Ruralpop</strong>.
        </p>

        <p class="text">
            Disculpa las molestias y bienvenido a Ruralpop.
        </p>
    ...
    const { data, error } = await resend.emails.send({
        ...
        to: [recipient],
        subject: 'Registro en Ruralpop solucionado',
        html: emailHtml
    });
    ...
    if (error) {
        ...
        console.log("✅ Email sent successfully to Adrian! Data:", data);
    }
}
